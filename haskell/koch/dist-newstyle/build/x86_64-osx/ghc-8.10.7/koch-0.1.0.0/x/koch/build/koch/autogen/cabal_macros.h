...
/* package koch-0.1.0.0 */
#ifndef VERSION_koch
#define VERSION_koch "0.1.0.0"
#endif /* VERSION_koch */
#ifndef MIN_VERSION_koch
#define MIN_VERSION_koch(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_koch */
...
#define CURRENT_COMPONENT_ID "koch-0.1.0.0-inplace-koch"
